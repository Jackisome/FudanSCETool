...
public class EstimateSystemController {
    ...
    public xxx showAllHistoryProject() {}

    public xxx showApply() {}

    public boolean aggreToAddDatabase() {}

    public boolean addHistoryProject() {}

    public boolean trainModel() {}

    public boolean deleteHistoryProject() {}
